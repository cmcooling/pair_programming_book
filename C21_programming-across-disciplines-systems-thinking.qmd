...
In his *Introduction to Systems Thinking*, Daniel Kim details the different modes we can act in when dealing with a system. [@c21_DanielKimSystemsThinkingModes] Thinking about these modes, particularly within the context of computational thinking, allows us to transcend from being acted on by a system to acting on a system.

Our interactions with systems are normally restricted to reacting to what it does. After observing enough of its behaviour, we can notice patterns in those events we can adapt to. A system’s architecture, also referred to as a “systemic structure”, is the way a system’s components are organised. It is responsible for the events and patterns we observe. [@c21_DanielKimSystemsThinkingModes]
